    ...
    <div className="mx-auto w-full max-w-5xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between gap-50">
          <div className="mb-6 md:mb-0 w-1/2">
              <a href="https://pusamadaind.com/" className="flex items-center">
                  <img src="/pusamada-logo.png" className="h-8 me-3" alt="PUSAMADA Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 md:grid-cols-2 w-full">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Link</h2>
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
					  ...
					  <li className="mb-2">
                          <Link href="/seminar" className="hover:underline">Seminar</Link>
                      </li>
					  <li className="mb-2">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Media Sosial</h2>
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-2">
      ...
      <div className="sm:flex justify-center">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">2025 <a href="https://pusamadaind.com/" className="hover:underline">Pusaka Mande Muda Indonesia</a>
          </span>
